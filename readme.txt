...
2018-02-16 -- added code to sac.php to use data from freegeopip.net to create default usernames based on geolocation data. Also added code to restrict usernames that unregistered users can create in the chat box. 
